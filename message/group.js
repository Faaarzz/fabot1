...
_Jangan lupa baca deskripsi group!_ \n\n_*Stay Healthy*_ `
	...
	nino.sendMessage(mdata.id, { contentText: `${teks}`, footerText: '© Pikaw-Bot', buttons: [ { buttonId: `o`, buttonText: { displayText: 'Welcome' }, type: 1 }, ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: buff, contextInfo: {mentionedJid: [num]}}}, 'buttonsMessage')
            ...
            if (!welkom.includes(anu.jid)) return
                ...
                buff = await getBuffer(pp_user)
                nino.sendMessage(mdata.id, { contentText: `${out}`, footerText: '© Pikaw-Bot', buttons: [ { buttonId: `o`, buttonText: { displayText: 'Byee' }, type: 1 }, ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: buff, contextInfo: {mentionedJid: [num]}}}, 'buttonsMessage')
